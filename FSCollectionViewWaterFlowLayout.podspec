#
#  Be sure to run `pod spec lint FSCollectionViewWaterFlowLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Fredcom/FSCollectionViewWaterFlowLayout.git", :tag => "#{s.version}" }
